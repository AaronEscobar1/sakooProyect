...
func (ThirdPartyAccount) Annotations() []schema.Annotation {
	return []schema.Annotation{
		entsql.Annotation{Table: "third_party_accounts", Schema: "finance"},
	}
}

func (ThirdPartyAccount) Fields() []ent.Field {
	return []ent.Field{
		field.Int64("user_id"),
		...
		field.String("document_number").MaxLen(50),
