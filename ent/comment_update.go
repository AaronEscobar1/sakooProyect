...
func (_u *CommentUpdate) SetRateID(v int64) *CommentUpdate {
	_u.mutation.ResetRateID()
	_u.mutation.SetRateID(v)
	return _u
}

// SetNillableRateID sets the "rate_id" field if the given value is not nil.
func (_u *CommentUpdate) SetNillableRateID(v *int64) *CommentUpdate {
	if v != nil {
		_u.SetRateID(*v)
	}
	return _u
...
// AddRateID adds value to the "rate_id" field.
func (_u *CommentUpdate) AddRateID(v int64) *CommentUpdate {
	_u.mutation.AddRateID(v)
	return _u
}
...
func (_u *CommentUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.UserIDCleared() {
		_spec.ClearField(comment.FieldUserID, field.TypeInt64)
	}
	if value, ok := _u.mutation.RateID(); ok {
		_spec.SetField(comment.FieldRateID, field.TypeInt64, value)
	}
	if value, ok := _u.mutation.AddedRateID(); ok {
		_spec.AddField(comment.FieldRateID, field.TypeInt64, value)
	}
	...
	_spec.Node.Schema = _u.schemaConfig.Comment
...
// SetRateID sets the "rate_id" field.
func (_u *CommentUpdateOne) SetRateID(v int64) *CommentUpdateOne {
	_u.mutation.ResetRateID()
	_u.mutation.SetRateID(v)
	return _u
}
...
// SetNillableRateID sets the "rate_id" field if the given value is not nil.
func (_u *CommentUpdateOne) SetNillableRateID(v *int64) *CommentUpdateOne {
	if v != nil {
		_u.SetRateID(*v)
	}
	return _u
...
// AddRateID adds value to the "rate_id" field.
func (_u *CommentUpdateOne) AddRateID(v int64) *CommentUpdateOne {
	_u.mutation.AddRateID(v)
	return _u
}
