...
func (_c *CommentCreate) SetNillableUserID(v *int64) *CommentCreate {
	if v != nil {
		_c.SetUserID(*v)
	}
	return _c
...
func (_c *CommentCreate) SetRateID(v int64) *CommentCreate {
	_c.mutation.SetRateID(v)
	return _c
}
...
func (_c *CommentCreate) check() error {
	if _, ok := _c.mutation.RateID(); !ok {
		return &ValidationError{Name: "rate_id", err: errors.New(`ent: missing required field "Comment.rate_id"`)}
	}
...
func (_c *CommentCreate) createSpec() (*Comment, *sqlgraph.CreateSpec) {
	...
	_spec.Schema = _c.schemaConfig.Comment
	if value, ok := _c.mutation.UserID(); ok {
		_spec.SetField(comment.FieldUserID, field.TypeInt64, value)
		_node.UserID = value
	}
	if value, ok := _c.mutation.RateID(); ok {
