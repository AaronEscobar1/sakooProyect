...
func (_c *UserCreate) SetSecondLastName(v string) *UserCreate {
	_c.mutation.SetSecondLastName(v)
	return _c
}

// SetNillableSecondLastName sets the "second_last_name" field if the given value is not nil.
func (_c *UserCreate) SetNillableSecondLastName(v *string) *UserCreate {
	if v != nil {
		_c.SetSecondLastName(*v)
	}
	return _c
}

// SetAvatarIndex sets the "avatar_index" field.
func (_c *UserCreate) SetAvatarIndex(v int) *UserCreate {
	_c.mutation.SetAvatarIndex(v)
	return _c
}

// SetNillableAvatarIndex sets the "avatar_index" field if the given value is not nil.
func (_c *UserCreate) SetNillableAvatarIndex(v *int) *UserCreate {
	if v != nil {
		_c.SetAvatarIndex(*v)
	}
	return _c
...
func (_c *UserCreate) SetUserTypeID(v int64) *UserCreate {
	_c.mutation.SetUserTypeID(v)
	return _c
}

// SetDocumentTypeID sets the "document_type_id" field.
func (_c *UserCreate) SetDocumentTypeID(v int64) *UserCreate {
	_c.mutation.SetDocumentTypeID(v)
	return _c
}

// SetNillableDocumentTypeID sets the "document_type_id" field if the given value is not nil.
func (_c *UserCreate) SetNillableDocumentTypeID(v *int64) *UserCreate {
	if v != nil {
...
func (_c *UserCreate) SetDocumentNumber(v string) *UserCreate {
	_c.mutation.SetDocumentNumber(v)
	return _c
}

// SetNillableDocumentNumber sets the "document_number" field if the given value is not nil.
func (_c *UserCreate) SetNillableDocumentNumber(v *string) *UserCreate {
	if v != nil {
...
func (_c *UserCreate) defaults() {
	if _, ok := _c.mutation.AvatarIndex(); !ok {
		v := user.DefaultAvatarIndex
		_c.mutation.SetAvatarIndex(v)
	}
...
func (_c *UserCreate) check() error {
	...
	if v, ok := _c.mutation.SecondLastName(); ok {
	...
	if _, ok := _c.mutation.AvatarIndex(); !ok {
		return &ValidationError{Name: "avatar_index", err: errors.New(`ent: missing required field "User.avatar_index"`)}
	}
	if _, ok := _c.mutation.UserTypeID(); !ok {
		return &ValidationError{Name: "user_type_id", err: errors.New(`ent: missing required field "User.user_type_id"`)}
	}
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.SecondLastName(); ok {
		_spec.SetField(user.FieldSecondLastName, field.TypeString, value)
		_node.SecondLastName = value
	}
	if value, ok := _c.mutation.AvatarIndex(); ok {
		_spec.SetField(user.FieldAvatarIndex, field.TypeInt, value)
		_node.AvatarIndex = value
	}
	if value, ok := _c.mutation.UserTypeID(); ok {
		_spec.SetField(user.FieldUserTypeID, field.TypeInt64, value)
		_node.UserTypeID = value
	}
	if value, ok := _c.mutation.DocumentTypeID(); ok {
		_spec.SetField(user.FieldDocumentTypeID, field.TypeInt64, value)
		_node.DocumentTypeID = value
	}
