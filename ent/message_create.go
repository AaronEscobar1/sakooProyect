...
func (_c *MessageCreate) SetNillableSenderID(v *int64) *MessageCreate {
	if v != nil {
		_c.SetSenderID(*v)
	}
	return _c
...
func (_c *MessageCreate) SetReceiverID(v int64) *MessageCreate {
	_c.mutation.SetReceiverID(v)
	return _c
}

// SetNillableReceiverID sets the "receiver_id" field if the given value is not nil.
func (_c *MessageCreate) SetNillableReceiverID(v *int64) *MessageCreate {
	if v != nil {
		_c.SetReceiverID(*v)
	}
	return _c
...
func (_c *MessageCreate) createSpec() (*Message, *sqlgraph.CreateSpec) {
	...
	_spec.Schema = _c.schemaConfig.Message
