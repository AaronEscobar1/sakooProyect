...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			paymentcommitment.Table:   paymentcommitment.ValidColumn,
			paymentnotification.Table: paymentnotification.ValidColumn,
			responsecode.Table:        responsecode.ValidColumn,
			thirdpartyaccount.Table:   thirdpartyaccount.ValidColumn,
			...
			usertype.Table:            usertype.ValidColumn,
		})
	})
